          ...
          <div class="card-body">
            ...
            <form >
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name ="name" value="{{ $studentreg->name }}" class="form-control" id="inputText" disabled>
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" value="{{ $studentreg->email }}" class="form-control" id="inputEmail" disabled>
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" name="phone" value="{{ $studentreg->phone_number }}" class="form-control" id="inputPassword" disabled>
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select class="form-select" name="age" aria-label="Default select example" disabled>
